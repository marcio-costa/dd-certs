...
│   │   └── drill-08-corner-cases-mixed.md      ← 20 documented exam traps (Week 4)
...
**40 markdown files · ~6,600 lines · 5 simulation formats.** Reviewed and corrected against current Datadog documentation (July 2026 instructor audit — see `INSTRUCTOR-REVIEW.md`).
