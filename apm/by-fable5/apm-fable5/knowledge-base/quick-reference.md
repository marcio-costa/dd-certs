...
| | **Live Tail** | **Explorer** |
|---|---|---|
| Window | Real-time stream (no lookback) | Index retention |
...
| Log-based metric retention | 15 months (10s granularity) |
| Index retention options | 3, 7, 15, 30, 45, 60, 90 days |
| Live Tail | Real-time only (sampled at high volume) |
| HTTP intake array | max 1,000 logs per request |
