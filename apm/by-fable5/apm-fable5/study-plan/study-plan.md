...
### Day 26 (Fri) — Final cleanup + corner cases

- **Drill (45m):** **Drill 08 — Corner Cases & Exam Traps** (`simulations/domain-drills/drill-08-corner-cases-mixed.md`). Anything you miss goes straight into `weak-areas.md`.
- **Re-drill (30m):** All remaining bullets in `weak-areas.md`. Anything you can't immediately explain → re-read that knowledge-base section.
- **Read (15m):** `quick-reference.md` end to end.
